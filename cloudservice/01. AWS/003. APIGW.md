...
![](https://storage.googleapis.com/zenn-user-upload/caf8a5bfa801-20230610.png)
...
> **Private APIs are only accessible through VPC endpoints** for API Gateway.
Create a VPC endpoint and add Resource Policy for the API to allow access.
![](https://storage.googleapis.com/zenn-user-upload/bd0d933702f7-20230610.png)

✅PrivateなAPIGWは、以下のような構成で**VPC endpoint経由でしかアクセスできない**もの。
![](https://storage.googleapis.com/zenn-user-upload/f45580a1bda2-20230610.png)
...
![](https://storage.googleapis.com/zenn-user-upload/5d5964039a5e-20230602.png)
