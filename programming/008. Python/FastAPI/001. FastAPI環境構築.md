...
# WSGI vs ASGI
👉FastAPIの実行環境であるuvicornはASGI Frameworkの１つである。<br>
👉ASGIの前身としてWSGIがある。違いはasync/awaitを使えるかどうか。
## WSGI
Web Server Gateway Interface　

**WSGI Frameworks**<br>
Bottle, Falcon, Flask, Django<br>
...
![](https://storage.googleapis.com/zenn-user-upload/0e3fd2f4effc-20230101.png)
...
・Daphne
・Mangum
![](https://storage.googleapis.com/zenn-user-upload/2eec79ffb0ac-20230101.png) 
